...
inherit alternatives distutils-r1 eutils flag-o-matic wxwidgets xdg-utils
...
# The hacky build system seems to be broken with out-of-source builds, and installs 'wx' package globally.
...
python_compile() {
	...
	distutils-r1_python_compile build --build-purelib "${BUILD_DIR}"/lib.common
